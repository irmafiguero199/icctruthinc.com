...
const About = () => {
  const milestones = [
    { year: '2009', title: 'Foundation', desc: 'Vernon Maden established in Lubbock, TX with initial focus on youth tutoring and community resource sharing.' },
    ...
    { year: '2013', title: 'Program Expansion', desc: 'Launched adult literacy and workforce development programs in partnership with Lubbock County libraries.' },
    ...
    { year: '2019', title: 'Strategic Growth', desc: 'Expanded service area to include all of Lubbock County; awarded first major community grant ($75,000).' },
  ...
  return (
    <>
      <Helmet>
        <title>About Us | Vernon Maden | 501(c)(3) Nonprofit</title>
        <meta name="description" content="Learn about Vernon Maden, our history, values, and commitment to the Lubbock community. Founded in 2009. EIN: 87-0974521." />
        <link rel="canonical" href="https://vernonmaden.com/about" />
      </Helmet>

      <div className="page-hero">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 font-serif">About Vernon Maden</h2>
        <p className="text-slate-300 text-lg">Our history, values, and commitment to the Lubbock community</p>
      </div>
      ...
      <div className="container-main px-4 py-16 max-w-4xl">
        ...
        <div className="info-box">
          ...
          <p className="text-slate-600"><strong>Legal Name:</strong> Vernon Maden</p>
          <p className="text-slate-600"><strong>Federal EIN:</strong> 87-0974521</p>
          <p className="text-slate-600"><strong>IRS Status:</strong> 501(c)(3) Public Charity</p>
          <p className="text-slate-600"><strong>State of Incorporation:</strong> Texas</p>
          <p className="text-slate-600"><strong>Year Founded:</strong> 2009</p>
          <p className="text-slate-600"><strong>Physical Address:</strong> 5731 70th Pl, Lubbock, TX 79424-1819</p>
        </div>
